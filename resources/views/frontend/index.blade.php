                  ...
                  <ul class="dropdown-menu mega-menu">
                    <li class="yamm-content">
                      <div class="row">
                        ...
                        <div class="dropdown-banner-holder"> <a href="#"><img alt="photos" src="{{ asset('styles_frontend/assets/images/banners/banner-side.png') }}" /></a> </div>
                      </div>
                      <!-- /.row --> 
                    </li>
                    <!-- /.yamm-content -->
                  ...
                  <ul class="dropdown-menu mega-menu">
                    <li class="yamm-content">
                      <div class="row">
                        ...
                        <div class="dropdown-banner-holder"> <a href="#"><img alt="" src="{{ asset('styles/frontend/assets/images/banners/banner-side.png') }}" /></a> </div>
                      </div>
                      <!-- /.row --> 
                    </li>
                    <!-- /.yamm-content -->
                  ...
                  <ul class="dropdown-menu mega-menu">
                    <li class="yamm-content">
                      <div class="row">
                        ...
                        <div class="dropdown-banner-holder"> <a href="#"><img alt="" src="{{ asset('styles_frontend/assets/images/banners/banner-side.png') }}" /></a> </div>
                      </div>
                      <!-- /.row --> 
                    </li>
                    <!-- /.yamm-content -->
